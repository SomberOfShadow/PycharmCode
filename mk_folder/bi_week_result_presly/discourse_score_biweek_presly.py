...
# Presly Members name & EID Bi-weeks results
PRESLY_MEMBERS_NAMES_AND_EIDS = ["Bin WU A:ebinwwu", "Daisy WANG M:ewameil", "Dianny Chen:edanchn",
...
folder = abpath + "\\" + "biweek_discourse_result_presly" + "\\" + start_date + "_to_" + end_date
...
def send_mail():
    ...
    # to_address = 'hengtai.nie@ericsson.com'
    to_address = 'lily.zhao@ericsson.com'
...
if __name__ == '__main__':
    ...
    for i in range(len(PRESLY_MEMBERS_NAMES_AND_EIDS)):
        EID = (PRESLY_MEMBERS_NAMES_AND_EIDS[i].split(":")[1])
