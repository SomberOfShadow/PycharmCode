...
PDLENCRDVT_MEMBERS_NAMES_AND_EIDS = ["Bin WU A:ebinwwu", "Daisy WANG M:ewameil", "Dianny Chen:edanchn",
                                     "Hengtai Nie:eenheni", "HuanJun Jiang:EHUNJNG", "Lily Zhao:EIZLALH", "Maxwell MA:exiimaa",
                                     "Ning ZHANG N:enigzhg", "Peng ZHOU:ezhopen", "Tao Sha:eshatao", "Yehui WANG:eyehwan",
...
def get_topic_reply(topic_reply_monthly_url, EID):
    ...
    list_score.append("EID:" + EID + " Topic:" + str(topic_number) + " Reply:" + str(reply_number))
...
def get_solution(solution_url, EID):
    ...
    for value in solution_class:
        ...
        # 打印每个人solution个数
        print("Solution numbers:" + str(len(time_list)))
        print("#########")
